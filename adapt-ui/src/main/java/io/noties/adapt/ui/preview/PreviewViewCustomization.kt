...
interface PreviewViewCustomization {
    ...
    fun preview(@ColorInt color: Int, view: View): Drawable

    companion object : PreviewViewCustomization {
        override fun preview(@ColorInt color: Int, view: View): Drawable {
            // by default bounds and padding drawables are used to preview
            return PreviewDrawable.default(view, color)
        }
...
//        private val boundsPaint = Paint(Paint.ANTI_ALIAS_FLAG).also {
...
//        private val paddingPaint = Paint(Paint.ANTI_ALIAS_FLAG).also {
...
//            val half = (boundsPaint.strokeWidth / 2F).roundToInt()
//            boundsRect.set(bounds)
//            boundsRect.inset(half, half)
//
//            canvas.drawRect(boundsRect, boundsPaint)
//
//            if (!paddingPath.isEmpty) {
