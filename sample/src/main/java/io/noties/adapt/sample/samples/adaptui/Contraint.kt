...
//    val top
    ...
    fun layoutMargins(leading: Int? = null, top: Int? = null, trailing: Int? = null, bottom: Int? = null)
    ...
    val <V: View, LP: LayoutParams> ViewElement<V, LP>.leading: ElementEdge
    val <V: View, LP: LayoutParams> ViewElement<V, LP>.top: ElementEdge
    val <V: View, LP: LayoutParams> ViewElement<V, LP>.trailing: ElementEdge
    val <V: View, LP: LayoutParams> ViewElement<V, LP>.bottom: ElementEdge

    // links to other baseline,top,bottom
    val <V: View, LP: LayoutParams> ViewElement<V, LP>.baseline: ElementEdge
}

fun <V: View, LP: LayoutParams> ViewElement<V, LP>.layoutConstraints(
...
fun hey() {
    ...
    val el = ViewElement<View, LayoutParams> { View(it) }
